...
from .models import (
    ...
    Tipo_Servicio, Laboratorios, Horarios_Laboratorio # CORREGIDO: Usar Horarios_Laboratorio
)
...
class LaboratoriosSerializer(serializers.ModelSerializer):
    class Meta:
        model = Laboratorios
        fields = '__all__'
        read_only_fields = ('Laboratorio_Id',) # Se añade read_only
...
class ObjetoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Objetos
        fields = ('Objetos_Id', 'Nombre_Objetos', 'Descripcion', 'Cant_Stock', 'Categoria_Id', 'nombre_categoria')
        read_only_fields = ('Objetos_Id', 'nombre_categoria') 

class HorariosLaboratorioSerializer(serializers.ModelSerializer):
    # Añadimos el nombre del laboratorio para el GET
    nombre_laboratorio = serializers.CharField(source='Laboratorio_Id.Nombre_Laboratorio', read_only=True)
    
    class Meta:
        model = Horarios_Laboratorio # CORREGIDO
...
class EntregasSerializer(serializers.ModelSerializer):
    # Añadimos el nombre de la frecuencia para claridad
